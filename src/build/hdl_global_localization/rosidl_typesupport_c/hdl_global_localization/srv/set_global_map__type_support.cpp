...
static const _SetGlobalMap_Request_type_support_symbol_names_t _SetGlobalMap_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hdl_global_localization, srv, SetGlobalMap_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hdl_global_localization, srv, SetGlobalMap_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hdl_global_localization, srv, SetGlobalMap_Request)() {
  return &::hdl_global_localization::srv::rosidl_typesupport_c::SetGlobalMap_Request_message_type_support_handle;
}
...
static const _SetGlobalMap_Response_type_support_symbol_names_t _SetGlobalMap_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hdl_global_localization, srv, SetGlobalMap_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hdl_global_localization, srv, SetGlobalMap_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_hdl_global_localization
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hdl_global_localization, srv, SetGlobalMap_Response)() {
  return &::hdl_global_localization::srv::rosidl_typesupport_c::SetGlobalMap_Response_message_type_support_handle;
}
...
static const _SetGlobalMap_type_support_symbol_names_t _SetGlobalMap_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hdl_global_localization, srv, SetGlobalMap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hdl_global_localization, srv, SetGlobalMap)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hdl_global_localization, srv, SetGlobalMap)() {
  return &::hdl_global_localization::srv::rosidl_typesupport_c::SetGlobalMap_service_type_support_handle;
}
