...
#ifndef HDL_GLOBAL_LOCALIZATION__SRV__DETAIL__SET_GLOBAL_LOCALIZATION_ENGINE__FUNCTIONS_H_
#define HDL_GLOBAL_LOCALIZATION__SRV__DETAIL__SET_GLOBAL_LOCALIZATION_ENGINE__FUNCTIONS_H_
...
/// Initialize srv/SetGlobalLocalizationEngine message.
/**
...
/// Finalize srv/SetGlobalLocalizationEngine message.
/**
...
/// Create srv/SetGlobalLocalizationEngine message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Request__init().
...
/// Destroy srv/SetGlobalLocalizationEngine message.
/**
 * It calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Request__fini()
...
/// Check for srv/SetGlobalLocalizationEngine message equality.
/**
...
/// Copy a srv/SetGlobalLocalizationEngine message.
/**
...
/// Initialize array of srv/SetGlobalLocalizationEngine messages.
/**
...
/// Finalize array of srv/SetGlobalLocalizationEngine messages.
/**
 * It calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Request__fini()
...
/// Create array of srv/SetGlobalLocalizationEngine messages.
/**
 * It allocates the memory for the array and calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetGlobalLocalizationEngine messages.
/**
 * It calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetGlobalLocalizationEngine message array equality.
/**
...
/// Copy an array of srv/SetGlobalLocalizationEngine messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hdl_global_localization
...
/**
 * It calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_hdl_global_localization
...
/**
 * It allocates the memory for the array and calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_hdl_global_localization
...
/**
 * It calls
 * hdl_global_localization__srv__SetGlobalLocalizationEngine_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HDL_GLOBAL_LOCALIZATION__SRV__DETAIL__SET_GLOBAL_LOCALIZATION_ENGINE__FUNCTIONS_H_
