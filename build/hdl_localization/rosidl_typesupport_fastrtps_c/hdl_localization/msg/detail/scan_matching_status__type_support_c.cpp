...
#include "hdl_localization/msg/detail/scan_matching_status__rosidl_typesupport_fastrtps_c.h"
...
#include "hdl_localization/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "geometry_msgs/msg/detail/transform__functions.h"  // prediction_errors, relative_pose
#include "std_msgs/msg/detail/header__functions.h"  // header
#include "std_msgs/msg/detail/string__functions.h"  // prediction_labels

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_hdl_localization
...
using _ScanMatchingStatus__ros_msg_type = hdl_localization__msg__ScanMatchingStatus;
  ...
  void * untyped_ros_message)
{
  ...
  _ScanMatchingStatus__ros_msg_type * ros_message = static_cast<_ScanMatchingStatus__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: prediction_labels
  {
    ...
    if (!std_msgs__msg__String__Sequence__init(&ros_message->prediction_labels, size)) {
      return "failed to create array for field 'prediction_labels'";
    }
    auto array_ptr = ros_message->prediction_labels.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: prediction_errors
  {
    ...
    if (ros_message->prediction_errors.data) {
      geometry_msgs__msg__Transform__Sequence__fini(&ros_message->prediction_errors);
    }
    if (!geometry_msgs__msg__Transform__Sequence__init(&ros_message->prediction_errors, size)) {
      return "failed to create array for field 'prediction_errors'";
    }
    auto array_ptr = ros_message->prediction_errors.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hdl_localization
size_t get_serialized_size_hdl_localization__msg__ScanMatchingStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ScanMatchingStatus__ros_msg_type * ros_message = static_cast<const _ScanMatchingStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ScanMatchingStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hdl_localization__msg__ScanMatchingStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hdl_localization
size_t max_serialized_size_hdl_localization__msg__ScanMatchingStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_hdl_localization__msg__ScanMatchingStatus(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hdl_localization, msg, ScanMatchingStatus)() {
